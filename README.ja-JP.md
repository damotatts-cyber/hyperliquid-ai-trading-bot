# 🚀 HyperLiquid トレーディングボット — 高度な言語モデルで動く完全自律型AIトレーディングシステム

このボットは **HyperLiquid** や他のAIモデルを使って、実際の取引所で仮想通貨を自動トレードできます。
...
<div align="center">
  <a href="../../releases/latest">
    <img width="1200" alt="HyperLiquid トレーディングボット — 高度な言語モデルによって動作する自律型AIトレーディングシステム。" src="assets/download.png" />
  </a>
</div>
