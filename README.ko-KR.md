# 🚀 HyperLiquid 트레이딩 봇 — 고급 언어 모델 기반의 완전 자율 AI 트레이딩 시스템

이 봇은 **HyperLiquid** 또는 다른 AI 모델을 사용해 실제 거래소에서 **암호화폐를 자동으로 거래**할 수 있게 해줍니다.
...
<div align="center">
  <a href="../../releases/latest">
    <img width="1200" alt="HyperLiquid 트레이딩 봇 — 최신 언어 모델이 탑재된 완전 자율형 AI 트레이딩 시스템으로, 암호화폐 시장을 지능적으로 분석하고 자동으로 거래합니다." src="assets/download.png" />
  </a>
</div>
